...
public class TombstoneClient {

	private String wzor;
	private CenyClient ceny;
	private Grubosci grubosci;
	private Wymiary wymiary;
	private Wykonczenia wykomczenia;
	
	public TombstoneClient() {
	}
	
	public TombstoneClient(String wzor,CenyClient ceny, Grubosci grubosci, Wymiary wymiary, Wykonczenia wykomczenia) {
		super();
		this.setWzor(wzor);
		this.ceny = ceny;
	...
	public CenyClient getCeny() {
		return ceny;
	}

	public void setCeny(CenyClient ceny) {
		this.ceny = ceny;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final TombstoneClient other = (TombstoneClient) obj;
